...
void loop() {
  ...
  delay(2000);
  sendVramChar({ 39, 1, (0b11 << 10) | (C3 << 7) | 'R' });
   sendVramChar({ 39, 2, (0b11 << 10) | (C1 << 7) | 'A' });
   sendVramChar({ 39, 3, (0b11 << 10) | (C1 << 7) | 'D' });
   sendVramChar({ 39, 4, (0b11 << 10) | (C2 << 7) | ' ' });
   sendVramChar({ 40, 1, (0b11<< 10) | (C6 << 7) | 'S' });
   sendVramChar({ 40, 2, (0b11 << 10) | (C4 << 7) | 'I' });
   sendVramChar({ 40, 3, (0b11 << 10) | (C4 << 7) | 'L' });
   sendVramChar({ 40, 4, (0b11 << 10) | (C2 << 7) | ' ' });
  delay(2000);
}